...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "warpcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"warpcointools.com", "dnsseed.warpcointools.com"},
    {"warpcoinpool.org", "dnsseed.warpcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"warpcointools.com", "testnet-seed.warpcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. warpcoin is probably already running."), addrBind.ToString().c_str());
        else
